...
//  DiskTracker
//
//  Global application state: navigation, the running scan, filtering,
//  selection, batch operations and export.
//
//  The value types it holds — DiskNode, FileKind, ScanState, ScanCategory,
//  AppPhase, DuplicateGroup — live in Models.swift.
//
